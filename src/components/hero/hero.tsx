        ...
        <>
            <div className="relative px-2 pt-6 bg-[#f2f0f1]  md:px-25 md:pt-20 overflow-hidden">
                ...
                <div className="relative md:w-1/2 z-20">
                    <h1 className="text-4xl md:text-7xl font-bold font-display">FIND CLOTHES THAT MATCHES YOUR STYLE</h1>
                    <p className="text-sm md:text-md pt-3 pb-3 text-[#616060] md:w-4/5 md:pt-5">Browse through our diverse range of meticulously crafted garments, designed to bring out your individuality and cater to your sense of style.</p>
                    <Link href=''>
                        <Button className="rounded-full w-full h-13 mb-3 md:w-1/3 md:mt-5 
                    ...
                    <div className="flex justify-between md:px-0 px-10 mb-3 flex-wrap md:w-full h-[95px] md:mt-10 items-center gap-y-4">
                        <span className="animate-in slide-in-from-bottom duration-700 delay-100">
                            ...
                            <p className="text-sm font-light text-[#616060]">International brands</p>
                        </span>
                        ...
                        >
                            <line x1="1" y1="-2.18557e-08" x2="1" y2="52" stroke="black" strokeOpacity="0.1" />
                        </svg>

                        <span className="animate-in slide-in-from-bottom duration-700 delay-300">
                            <p className="text-3xl md:text-5xl font-bold">2,000+</p>
                            <p className="text-sm font-light text-[#616060]">High-Quality products</p>
                        </span>
                        ...
                        <span className="mx-auto md:mx-0 animate-in slide-in-from-bottom duration-700 delay-500">
                            ...
                            <p className="text-sm font-light text-[#616060]">Happy customers</p>
                        </span>
                    </div>
