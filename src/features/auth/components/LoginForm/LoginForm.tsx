        ...
        <div className="p-10 md:bg-[url('/assets/images/herosection.png')] md:min-h-full">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <Button className="w-full rounded-3xl h-[50px] cursor-pointer" type="submit">Submit</Button>
                    <Link href={ROUTES.REGISTER}><Button className="w-full rounded-3xl h-[50px] cursor-pointer" variant={'outline'}>Create an account</Button></Link>
                </form>
            </Form>
        </div>
    )
