...
export default function ProductCard({ product }: { product: Product }) {
  return (
    <div className="min-w-[250px] flex flex-col items-start md:min-w-[280px] md:mb-5 md:mt-5 rounded-xl md:p-4 transition-transform duration-500 ease-out hover:scale-105 hover:-translate-y-2 hover:shadow-md">
